package com.abdo.montgat.ui.introSlider;
...
//        layoutDots = findViewById(R.id.layoutDots);
        progressBar = findViewById(R.id.progress_bar_intro);
        next = findViewById(R.id.next_iv_intro);
...
//        layoutDots.removeAllViews();
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setText(Html.fromHtml("&#9472"));
