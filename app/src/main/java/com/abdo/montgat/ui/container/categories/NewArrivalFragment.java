...
public class NewArrivalFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_new_arrival, container, false);
    ...
    private void initView() {
        ...
        productRV = view.findViewById(R.id.product_rv_new_arrival);

        List<ProductModel> list1 = new Data().getDataFromNewArrival();
        ...
        public void onBindViewHolder(@NonNull ProductVH holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("FROM_HOME","new");
                    productFragment.setArguments(bundle);
                    Constant.replaceFragment(NewArrivalFragment.this, productFragment);
                }
            });
        }
