...
public class TrendingFragment extends Fragment {
    ...
    private void initView() {
        productRV = view.findViewById(R.id.product_rv_trending);

        List<ProductModel> list1 = new Data().getDataFromTrending();
        ...
        public void onBindViewHolder(@NonNull ProductVH holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("FROM_HOME","trendingg");
                    productFragment.setArguments(bundle);
                    Constant.replaceFragment(TrendingFragment.this, productFragment);
                }
            });
        }
