...
public class ShoesFragment extends Fragment {
    ...
    private void initView() {
        ...
        productRV = view.findViewById(R.id.product_rv_shoes);

        List<ProductModel> list1 = new Data().getDataFromShoes();
        ...
        public void onBindViewHolder(@NonNull ProductVH holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("FROM_HOME","shoes");
                    productFragment.setArguments(bundle);
                    Constant.replaceFragment(ShoesFragment.this, productFragment);
                }
            });
        }
