...
public class CapFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_cap, container, false);
    ...
    private void initView() {
        ...
        productRV = view.findViewById(R.id.product_rv_cap);

        List<ProductModel> list1 = new Data().getDataFromCap();
        ...
        public void onBindViewHolder(@NonNull ProductVH holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("FROM_HOME","cap");
                    productFragment.setArguments(bundle);
                    Constant.replaceFragment(CapFragment.this, productFragment);
                }
            });
        }
