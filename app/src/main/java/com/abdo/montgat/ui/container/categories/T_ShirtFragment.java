...
public class T_ShirtFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_t_shirt, container, false);
        return view;
    }
    ...
    private void initView() {
        productRV = view.findViewById(R.id.product_rv_t_shirt);

        List<ProductModel> list1 = new Data().getDataFromT_Shirt();
    ...
    private class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductVH> {
        ...
        public void onBindViewHolder(@NonNull ProductVH holder, int position) {
            final ProductModel trending = productList.get(position);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   ...
                   ProductFragment productFragment = new ProductFragment();
                    ...
                    bundle.putString("FROM_HOME","t_shirt");
                    productFragment.setArguments(bundle);
                    Constant.replaceFragment(T_ShirtFragment.this, productFragment);
                }
            });
