...
public class CoatFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_coat, container, false);
    ...
    private void initView() {
        ...
        productRV = view.findViewById(R.id.product_rv_coat);

        List<ProductModel> list1 = new Data().getDataFromCoat();
        ...
        public void onBindViewHolder(@NonNull ProductVH holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("FROM_HOME","coat");
                    productFragment.setArguments(bundle);
                    Constant.replaceFragment(CoatFragment.this, productFragment);
                }
            });
        }
