...
public class TrousersFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_trousers, container, false);
    ...
    private void initView() {
        ...
        productRV = view.findViewById(R.id.product_rv_trousers);

        List<ProductModel> list1 = new Data().getDataFromTrousers();
        ...
        public void onBindViewHolder(@NonNull ProductVH holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("FROM_HOME","trousers");
                    productFragment.setArguments(bundle);
                    Constant.replaceFragment(TrousersFragment.this, productFragment);
                }
            });
        }
