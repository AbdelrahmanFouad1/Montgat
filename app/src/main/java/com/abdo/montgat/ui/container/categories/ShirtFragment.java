...
public class ShirtFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_shirt, container, false);
    ...
    private void initView() {
        productRV = view.findViewById(R.id.product_rv_shirt);

        List<ProductModel> list1 = new Data().getDataFromShirt();
        ...
        public void onBindViewHolder(@NonNull ProductVH holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("FROM_HOME","shirt");
                    productFragment.setArguments(bundle);
                    Constant.replaceFragment(ShirtFragment.this, productFragment);
                }
            });
        }
    ...
    private void readCursorData(ProductModel trending, ShirtFragment.ProductAdapter.ProductVH holder) {
